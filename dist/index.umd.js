(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('buffer'), require('string_decoder'), require('stream'), require('util'), require('http'), require('url'), require('https'), require('zlib')) :
	typeof define === 'function' && define.amd ? define(['exports', 'buffer', 'string_decoder', 'stream', 'util', 'http', 'url', 'https', 'zlib'], factory) :
	(factory((global.LeanContentApi = {}),global.require$$0,global.string_decoder,global.require$$1,global.util,global.http,global.url,global.https,global.zlib));
}(this, (function (exports,require$$0,string_decoder,require$$1,util,http,url,https,zlib) { 'use strict';
...
var require$$0$2 = ( shiftjis$1 && shiftjis ) || shiftjis$1;
...
var get_article = getArticle;

async function getStage(articleIds) {
  const articlePromises = articleIds.map(articleId => get_article(articleId));
  return await Promise.all(articlePromises);
}

var get_stage = getStage;

var src = { getArticle: get_article, getStage: get_stage };
var src_1 = src.getArticle;
var src_2 = src.getStage;

exports.default = src;
exports.getArticle = src_1;
exports.getStage = src_2;
